...
AS $$
DECLARE
  project_url TEXT := 'https://osbyibnlppeciweqhcnm.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9zYnlpYm5scHBlY2l3ZXFoY25tIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MjMxODU2NywiZXhwIjoyMDU3ODk0NTY3fQ.fhbKI_lfIfHdotvoYi65xl318rd4vXyXj3UQFHpodFQ'; -- full access needed for http request to storage
